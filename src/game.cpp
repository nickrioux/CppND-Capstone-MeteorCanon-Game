...
Game::Game() : _sdl_window(nullptr), _sdl_renderer(nullptr), _gen(_rd()) {
...
void Game::loadLevel(int levelNo) {
    ...
    Entity & leftWall = GetEntityManager().AddEntity("left_boundary",GameConstants::COLLIDE_ENTITY,GameConstants::PLAYER_LAYER);
    ...
    Entity & rightWall = GetEntityManager().AddEntity("right_boundary",GameConstants::COLLIDE_ENTITY,GameConstants::PLAYER_LAYER);
    ...
    Entity & ground = GetEntityManager().AddEntity("ground",GameConstants::COLLIDE_ENTITY,GameConstants::PLAYER_LAYER);
    ground.AddComponent<TransformComponent>(0,GetHeight()-64-12,0,0,GetWidth(),2000,1.0);
    ground.AddComponent<ColliderComponent>("GROUND",0,GetHeight()-64-12,GetWidth(),2000);
...
void Game::update(std::size_t target_frame_duration ) {
    ...
    if ((_ticksLastKill == 0) && (_lifes == 0) && (gameState == GameConstants::GAME_STATE_RUNNING)) //GameOver
    {
        ...
        Entity & gameOverLabel = GetEntityManager().AddEntity("gameOverLabel", GameConstants::UI_ENTITY, GameConstants::UI_LAYER);
...
void Game::updateUI() {
  ...
  TextLabelComponent * lifeLabel = _lifeLabel->GetComponent<TextLabelComponent>();
...
void Game::processMeteorExplode (Entity * meteor)
{
    ...
    else if (rand() % 2)
    {
        ...
        Entity & smallRock1 = GetEntityManager().AddEntity(GameConstants::SMALL_METEOR_ENTITY_NAME,GameConstants::SMALL_METEOR_ENTITY,GameConstants::NPC_LAYER);
        ...
        Entity & smallRock2 = GetEntityManager().AddEntity(GameConstants::SMALL_METEOR_ENTITY_NAME,GameConstants::SMALL_METEOR_ENTITY,GameConstants::NPC_LAYER);
...
void Game::GenerateBullet(const TransformComponent & transformComp) {
    Entity & bulletEntity = GetEntityManager().AddEntity("bullet",GameConstants::BULLET_ENTITY,GameConstants::BULLET_LAYER);
...
void Game::generateMeteor(float deltaTime) {
    ...
    if ((generateTime > (GameConstants::TIME_FREQ_METEOR)) || (_fallingObjects < 2)) {
      ...
      {
          type = (type - 5);
          Entity & asteroidEntity = GetEntityManager().AddEntity(GameConstants::SMALL_METEOR_ENTITY_NAME,GameConstants::SMALL_METEOR_ENTITY,GameConstants::NPC_LAYER);
      ...
      {
          Entity & asteroidEntity = GetEntityManager().AddEntity(GameConstants::BIG_METEOR_ENTITY_NAME+std::to_string(type),GameConstants::BIG_METEOR_ENTITY,GameConstants::NPC_LAYER);
...
void Game::generateSpinner(float deltaTime)
{
    ...
    if ((generateTime > GameConstants::TIME_FREQ_SPINNER) || (_fallingObjects < 2)) {
            ...
            if (spinnerType) {
                ...
                Entity & spinnerEntity = GetEntityManager().AddEntity(GameConstants::SMALL_SPINNER_ENTITY_NAME, GameConstants::SMALL_SPINNER_ENTITY, GameConstants::NPC_LAYER);
            ...
            {
                Entity & spinnerEntity = GetEntityManager().AddEntity(GameConstants::BIG_SPINNER_ENTITY_NAME, GameConstants::BIG_SPINNER_ENTITY, GameConstants::NPC_LAYER);
...
void Game::generateExplosion(glm::vec2 pos, bool death) {
        ...
        if (death) {
            ...
            Entity & explosion1 = GetEntityManager().AddEntity("explosion",GameConstants::EXPLOSION_ENTITY, GameConstants::NPC_LAYER);
            Entity & explosion2 = GetEntityManager().AddEntity("explosion",GameConstants::EXPLOSION_ENTITY, GameConstants::NPC_LAYER);
            Entity & explosion3 = GetEntityManager().AddEntity("explosion",GameConstants::EXPLOSION_ENTITY, GameConstants::NPC_LAYER);
            Entity & explosion4 = GetEntityManager().AddEntity("explosion",GameConstants::EXPLOSION_ENTITY, GameConstants::NPC_LAYER);
            Entity & explosion5 = GetEntityManager().AddEntity("explosion",GameConstants::EXPLOSION_ENTITY, GameConstants::NPC_LAYER);
            ...
            //Create Entity Explosion
             Entity & explosionEntity = GetEntityManager().AddEntity("explosion",GameConstants::EXPLOSION_ENTITY, GameConstants::NPC_LAYER);
