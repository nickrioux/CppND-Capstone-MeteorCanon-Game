...
TextLabelComponent::TextLabelComponent(int x, int y, const std::string & text, const std::string & fontFamily, const SDL_Color& color) : _position{x,y}, _text{text}, _fontFamily{fontFamily}, _color{color}, _texture{nullptr} {
